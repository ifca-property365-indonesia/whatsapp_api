...
export class DueReminderService {
  ...
  async dataDueReminder(DueReminderDto: DueReminderDto) {
    /* ===============================
    * 1. SET LINK
    * =============================== */
    const link =
      DueReminderDto.environment === 'sandbox'
    ...
    retry(
      () =>
        this.accessCodeService.saveFirstMessagesLog({
          ...
          phone_number: DueReminderDto.wa_no,
          file_location: '-',
          debtor_name: DueReminderDto.due_no,
